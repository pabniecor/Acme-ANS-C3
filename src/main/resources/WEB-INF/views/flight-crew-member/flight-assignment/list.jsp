...
<acme:list>
	...
	<acme:list-column code="member.flight-assignment.list.label.flight-crew-member" path="flightCrew" width="20%"/>
	<acme:list-payload path="payload"/>
</acme:list>

<acme:button code="administrator.aircraft.list.button.create" action="/flight-crew-member/flight-assignment/create"/>