...
@GuiService
public class MemberFlightAssignmentListCompleteService extends AbstractGuiService<FlightCrewMember, FlightAssignment> {
	...
	public void load() {
		...
		flightAssignments = this.repository.findAllFlightAssignmentCompleted(moment, memberId);
